...
describe ReferencesController do
  ...
  let(:valid_attributes) { { "application_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reference as @reference" do
        ...
        post :create, {:reference => { "application_id" => "invalid value" }}, valid_session
        assigns(:reference).should be_a_new(Reference)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reference" do
        ...
        Reference.any_instance.should_receive(:update_attributes).with({ "application_id" => "1" })
        put :update, {:id => reference.to_param, :reference => { "application_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reference as @reference" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reference.any_instance.stub(:save).and_return(false)
        put :update, {:id => reference.to_param, :reference => { "application_id" => "invalid value" }}, valid_session
        assigns(:reference).should eq(reference)
      end
